...
(() => {
    ...
    async function fetchMarketJSON(forceFetch = false) {
        ...
        if (
            ...
            if (jsonObj) {
                reasonForUsingExpiredMarketJson += "/n using previously fetched version";
                return jsonObj;
            }
        }

        // Use hard-coded backup version
        reasonForUsingExpiredMarketJson += "/n using hard-coded backup version";
