...
(() => {
    ...
    let settingsMap = {
        ...
        showDamage: {
            id: "showDamage",
            desc: "战斗时，人物头像下方显示：伤害统计数字",
            isTrue: true,
        },
        showDamageGraph: {
            id: "showDamageGraph",
            desc: "战斗时，悬浮窗显示：伤害统计图表 [依赖上一项]",
            isTrue: true,
        },
    };
    readSettings();
    ...
    const lang = {
        panelHeader: isChinese ? "伤害统计" : "Damage Statistics",
        toggleButtonHide: isChinese ? "收起" : "Hide",
        toggleButtonShow: isChinese ? "展开" : "Show",
    };
